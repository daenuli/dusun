...
{
    private $folder = 'admin.education';
    private $uri = 'admin.education';
    private $title = 'Blood';
    private $desc = 'Description';

    use CrudTrait;

    public function __construct(Education $table) 
    {
    	$this->table = $table;
    }
    ...
    {
        $data['form'] = $formBuilder->create('App\Forms\EducationForm', [
            'method' => 'POST',
