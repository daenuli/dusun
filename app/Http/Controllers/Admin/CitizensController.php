    	...
    	if ($request->ajax()) {
            ...
            // ->editColumn('id','<input type="checkbox" class="checkbox" name="id[]" value="{{$id}}"/>')
	            ...
	            ->addColumn('action', function ($index) {
	                ...
	                $tag .= (Auth::user()->id == 1) ? " <button type='submit' class='delete btn btn-danger btn-xs'>Delete</button>" : " <button type='submit' class='delete btn btn-danger btn-xs' disabled=''>Delete</button>";
